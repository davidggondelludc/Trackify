...
class UserFollowingAdapter() :
    ListAdapter<UserFollowing, UserFollowingAdapter.UserFollowingViewHolder>(UserFollowingDiffUtil()) {
    ...
    inner class UserFollowingViewHolder(binding: UserFollowingItemBinding) :
    ...
    override fun onBindViewHolder(holder: UserFollowingViewHolder, position: Int) {
        ...
        holder.playlistFollowersTextView.text =
            "${currentUserFollowing.sharedPlaylists} shared playlists"
    }
}